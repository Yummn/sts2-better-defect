...
internal static class BdLocalization
{
    private static readonly Dictionary<string, string> Map = new()
    {
        ...
        ["powers/BD_STORM_CHARGE_POWER.title"] = "雷暴",
        ["powers/BD_STORM_CHARGE_POWER.description"] = "每生成1个闪电，下一张攻击的每段伤害增加 {Amount} 点。",
        ["powers/BD_STORM_CHARGE_POWER.smartDescription"] = "每当你[gold]生成[/gold]1个[gold]闪电[/gold]充能球，下一张攻击的每段伤害增加[blue]{Amount}[/blue]点。",
    ...
    private static void RefreshVersionSensitiveCardDescriptions(LocManager manager)
    {
        ...
        var descriptions = new Dictionary<string, string>
        {
            ...
            ["STORM.description"] = stormCustom
                ? "每当你[gold]生成[/gold]1个[gold]闪电[/gold]充能球，下一张攻击的每段伤害增加{StormPower:diff()}点。"
        ...
        var powerDescriptions = new Dictionary<string, string>
        {
            ...
            ["BD_STATIC_DISCHARGE_POWER.description"] = staticDischargeCustom
                ? "每当受到未被格挡的敌人攻击伤害，生成{Amount}个闪电并获得3点格挡。"
                : "每当你受到未被格挡的攻击伤害，充能{Amount}个闪电。",
            ["BD_STATIC_DISCHARGE_POWER.smartDescription"] = staticDischargeCustom
                ? "每当受到未被格挡的敌人攻击伤害，[gold]生成[/gold][blue]{Amount}[/blue]个[gold]闪电[/gold]充能球，并获得[blue]3[/blue]点[gold]格挡[/gold]。"
