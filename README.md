...
- [v0.11.63](https://github.com/Yummn/sts2-better-defect/releases/tag/v0.11.63): fixes transformed Hyperbeam's missing post-play animation. Its custom resolution now preserves the native Cast animation, sweeping `NHyperbeamVfx`, and one `NHyperbeamImpactVfx` per living enemy while retaining the temporary -3 Focus rule. Android v110.1 live combat verification created one beam and four impacts, completed the play, and restored Focus at turn end. Android v103, Android v110.1 and PC v107.1 packages are provided.
- [v0.11.62](https://github.com/Yummn/sts2-better-defect/releases/tag/v0.11.62): moves transformed Recycle's previous Orb-slot effect to a new Stack transformation. Transformed Stack costs 1 (0), Exhausts one selected hand card when available, always gains one Orb slot, and Exhausts itself. Transformed Recycle is Common, costs 1 (0), Exhausts one selected hand card, refunds that card's current Energy cost (including current X for X-cost cards), and no longer Exhausts itself. Android v110.1 live combat verification passed both base effects and both upgraded costs. Android v103, Android v110.1 and PC v107.1 packages are provided.
- [v0.11.61](https://github.com/Yummn/sts2-better-defect/releases/tag/v0.11.61): redesigns transformed Bulk Up. It costs 2 Energy, or 1 when normally upgraded; it first loses one Orb slot, then grants Strength and Dexterity equal to the remaining Orb-slot count. It no longer installs the old power that rewarded later slot losses. Android v110.1 live combat verification observed `3 -> 2` Orb slots, `+2` Strength, `+2` Dexterity, no legacy power, and upgraded cost 1. Android v103, Android v110.1 and PC v107.1 packages are provided.
- [v0.11.60](https://github.com/Yummn/sts2-better-defect/releases/tag/v0.11.60): raises transformed Hailstorm from 2 (3) to 3 (4) damage for every Frost orb. Each Frost still creates its own damage event against every enemy, matching the card and status descriptions. Android v103, Android v110.1 and PC v107.1 packages are provided.
- [v0.11.59](https://github.com/Yummn/sts2-better-defect/releases/tag/v0.11.59): moves the current transformed Static Discharge design to transformed Storm. Storm is 1 Energy and Innate; every Lightning generated stores +2 (+3 when normally upgraded) damage for every hit of the next Attack. Transformed Static Discharge returns to its previous retaliatory design: after unblocked enemy Attack damage it channels 1 (2) Lightning and gains 3 Block, with Innate added by its normal upgrade. Android v103, Android v110.1 and PC v107.1 packages are provided.
- [v0.11.58](https://github.com/Yummn/sts2-better-defect/releases/tag/v0.11.58): moves Steam Barrier's current 8 (12) Block rule behind its optional transformation; the untransformed restored card returns to its original 6 (8) Block while both versions still lose 1 Block per play. Transformed Recycle is now 1 (0) Energy and always Exhausts, and it grants one Orb slot even when no hand card can be exhausted. Android v110.1 live combat verification passed all base, upgraded, transformed and empty-hand cases. Android v103, Android v110.1 and PC v107.1 packages are provided.
- [v0.11.57](https://github.com/Yummn/sts2-better-defect/releases/tag/v0.11.57): adds an optional transformation for Rebound. It costs 1, deals 9 damage (12 when normally upgraded), then lets the player choose one card from the discard pile and place it on top of the draw pile. Android v110.1 live combat verification dealt exactly 9 damage, selected Strike from the discard pile, drew that same card from the top, and completed the play without hanging. Android v103, Android v110.1 and PC v107.1 packages are provided.
- [v0.11.56](https://github.com/Yummn/sts2-better-defect/releases/tag/v0.11.56): raises the persistent card-transformation budget from 50 to 60 points. The stage thresholds remain 25 Normal points and 10 Overclock points, leaving 25 Overload points. Android v110.1 live encyclopedia verification displayed the saved state as `49/60` with all 60 HUD segments present. Android v103, Android v110.1 and PC v107.1 packages are provided.
- [v0.11.55](https://github.com/Yummn/sts2-better-defect/releases/tag/v0.11.55): transformed Hyperbeam now follows the official v0.111 beta rule—2 Energy, 24 (30) damage to all enemies, and lose 3 Focus only for the current turn. Android v110.1 live combat verification observed Focus `0 -> -3 -> 0` across the end-of-turn cleanup. Android v103, Android v110.1 and PC v107.1 packages are provided.
