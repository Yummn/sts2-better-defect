#!/usr/bin/env python3
"""Focused structural and binary audit for transformed Uproar v0.11.37."""
...
def audit_source(source_root: Path, label: str, check) -> None:
    ...
    check(f"{label}: manifest v0.11.37", manifest.get("version") == "0.11.37")
...
def main() -> int:
    ...
    lines = [
        "BetterDefect v0.11.37 transformed Uproar audit",
